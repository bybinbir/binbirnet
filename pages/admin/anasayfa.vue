<template>
  <div>
    <h1 class="text-3xl font-extrabold text-slate-900 dark:text-white mb-8">Anasayfa Icerik Yonetimi</h1>
    ...
    <div class="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 p-6">
      ...
      <div v-if="activeTab === 'features'">
        <div class="flex items-center justify-between mb-4">
          <label class="text-sm font-semibold text-slate-700 dark:text-slate-300">Feature Kartlari</label>
        ...
        <div class="space-y-4">
          <div v-for="(f, i) in form.features" :key="f.id" class="bg-slate-50 dark:bg-slate-900/50 rounded-xl p-4 space-y-3">
            ...
            <div class="grid grid-cols-2 gap-3">
              <input v-model="f.icon" placeholder="Icon adi" class="border border-slate-200 dark:border-slate-700 rounded-lg p-2 text-sm bg-white dark:bg-slate-900 text-slate-900 dark:text-white" />
              <input v-model="f.title" placeholder="Baslik" class="border border-slate-200 dark:border-slate-700 rounded-lg p-2 text-sm bg-white dark:bg-slate-900 text-slate-900 dark:text-white" />
              <input v-model="f.description" placeholder="Aciklama" class="border border-slate-200 dark:border-slate-700 rounded-lg p-2 text-sm bg-white dark:bg-slate-900 text-slate-900 dark:text-white" />
      ...
      <div v-if="activeTab === 'steps'">
        <div class="flex items-center justify-between mb-4">
          <label class="text-sm font-semibold text-slate-700 dark:text-slate-300">Adim Kartlari</label>
        ...
        <div class="space-y-4">
          <div v-for="(s, i) in form.steps" :key="s.id" class="bg-slate-50 dark:bg-slate-900/50 rounded-xl p-4 space-y-3">
            <div class="flex items-center justify-between">
              <span class="text-sm font-bold text-slate-700 dark:text-slate-300">Adim {{ i + 1 }}</span>
              <div class="flex items-center gap-2">
            ...
            <div class="grid grid-cols-2 gap-3">
              <input v-model="s.icon" placeholder="Icon adi" class="border border-slate-200 dark:border-slate-700 rounded-lg p-2 text-sm bg-white dark:bg-slate-900 text-slate-900 dark:text-white" />
              <input v-model="s.title" placeholder="Baslik" class="border border-slate-200 dark:border-slate-700 rounded-lg p-2 text-sm bg-white dark:bg-slate-900 text-slate-900 dark:text-white" />
            </div>
            <textarea v-model="s.description" placeholder="Aciklama" rows="2" class="w-full border border-slate-200 dark:border-slate-700 rounded-lg p-2 text-sm bg-white dark:bg-slate-900 text-slate-900 dark:text-white"></textarea>
      ...
      <div v-if="activeTab === 'sections'" class="space-y-6">
        <div>
          <h3 class="text-sm font-bold text-slate-700 dark:text-slate-300 mb-3">Paketler Bolumu</h3>
          <div class="space-y-3">
            <div>
              <label class="text-sm text-slate-500">Baslik</label>
            ...
            <div>
              <label class="text-sm text-slate-500">Alt Baslik</label>
        ...
        <div>
          <h3 class="text-sm font-bold text-slate-700 dark:text-slate-300 mb-3">Adimlar Bolumu</h3>
          <div>
            <label class="text-sm text-slate-500">Baslik</label>
      ...
      <div v-if="activeTab === 'cta'" class="space-y-4">
        ...
        <div>
          <div class="flex items-center justify-between mb-3">
            <label class="text-sm font-semibold text-slate-700 dark:text-slate-300">Feature Listesi</label>
          ...
          <div v-for="(f, i) in form.cta.features" :key="i" class="flex gap-2 mb-2 items-center">
            <input v-model="f.icon" placeholder="Icon" class="w-32 border border-slate-200 dark:border-slate-700 rounded-lg p-2 text-sm bg-white dark:bg-slate-900 text-slate-900 dark:text-white" />
...
const tabs = [
  { id: 'features', label: 'Feature Kartlari' },
  { id: 'steps', label: 'Adim Kartlari' },
  { id: 'sections', label: 'Bolum Basliklari' },
  { id: 'cta', label: 'CTA Bolumu' },
]
